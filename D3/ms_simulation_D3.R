...
##
##
## Function 'D3_v2' does the following:
##  - compute le D3 for a trio of taxa
##  - identifie the donor and recipient
##  - return the number of ghost lineages inside th trio tree
##
##
